export default {
  ...
  imageStudio: {
    badge: 'Image Composer',
    title: 'Image Studio',
    description: 'Use a dedicated image-generation group for image requests.',
    loadingKeys: 'Loading available API keys...',
    controlsTitle: 'Request Builder',
    controlsDescription: 'Write the prompt up top, tune settings below, and upload a reference image only when you want edit mode.',
    browserExecutionTitle: 'Runs with your selected API key',
    browserExecutionHint: 'This page sends image requests directly from your browser with the selected key. Results are previewed locally and are not stored by this page.',
    selectedKeyHint: 'Current key: {key}',
    badgePill: 'Image Tools',
    tabs: {
      generate: 'Generate',
      edit: 'Edit',
    },
    ...
    placeholders: {
      generatePrompt: 'Describe the image you want to generate',
      editPrompt: 'Describe the change you want to apply to the reference image',
    },
    hints: {
    ...
    results: {
      title: 'Results',
      description: 'Your latest image output appears here for preview and download.',
      count: '{count} image(s)',
      idle: 'Ready',
      pending: 'Processing',
      generated: 'Generation complete',
      edited: 'Edit complete',
      pendingHint: 'Large image requests can take a bit longer. Keep this page open while the gateway finishes the response.',
    ...
    errors: {
      ...
      promptRequired: 'Enter a prompt before submitting.',
      sourceImageRequired: 'Upload a source image before running image edit.',
      requestFailed: 'Image request failed',
      emptyResults: 'The gateway returned no images for this request.',
    },
  },
