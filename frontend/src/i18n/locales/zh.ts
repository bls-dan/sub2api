export default {
  ...
  imageStudio: {
    badge: '图像创作台',
    title: '生图工作台',
    description: '生图请使用生图专用分组。',
    loadingKeys: '正在加载可用 API 密钥...',
    controlsTitle: '请求参数',
    controlsDescription: '提示词在上，参考图和参数在下，上传参考图后会自动切换到编辑模式。',
    browserExecutionTitle: '请求会使用当前选中的 API Key',
    browserExecutionHint: '本页会在浏览器里直接使用所选密钥发送图片请求。结果只在本地预览，不会由本页额外保存。',
    selectedKeyHint: '当前密钥：{key}',
    tabs: {
      generate: '生图',
      edit: '编辑',
    },
    ...
    placeholders: {
      generatePrompt: '描述你想生成的画面内容',
      editPrompt: '描述你希望对参考图进行的修改',
    },
    hints: {
    ...
    results: {
      title: '结果预览',
      description: '最新一次图片输出会显示在这里，支持放大预览和单张下载。',
      count: '{count} 张图片',
      idle: '待发起',
      pending: '处理中',
      generated: '生图完成',
      edited: '编辑完成',
      pendingHint: '图片请求通常比普通文本更耗时，请在网关返回结果前保持当前页面开启。',
      revisedPrompt: '修订提示词',
      imageLabel: '图片 #{index}',
    },
    empty: {
    ...
    errors: {
      ...
      apiKeyRequired: '请先选择一个 API 密钥。',
      promptRequired: '提交前请输入提示词。',
      sourceImageRequired: '发起图片编辑前请先上传原图。',
      requestFailed: '图片请求失败',
      emptyResults: '网关已返回响应，但没有包含可展示的图片结果。',
    },
  },
